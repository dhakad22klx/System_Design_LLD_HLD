...
/*
he pipeline pattern is a series of stages connected by channels,
...
-Each stage has any number of inbound and outbound channels, except the first and last stages,
 ...
 The first stage is sometimes called the source or producer; the last stage is the sink or consumer.
